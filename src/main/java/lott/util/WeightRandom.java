...
//    
    ...
    public static void main(String[] args) {
        ...
        ItemWithWeight<Integer> server1 = new ItemWithWeight<>(2, 12.0);
        ItemWithWeight<Integer> server2 = new ItemWithWeight<>(12, 13.0);
        ItemWithWeight<Integer> server3 = new ItemWithWeight<>(10, 2.0);

        WeightRandom<Integer> weightRandom = new WeightRandom<>(Arrays.asList(server1, server2, server3));
